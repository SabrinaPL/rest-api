...
class DataService:
    ...
    def save_movies(self, movies_metadata):
        for movie in movies_metadata[:100]:  # Limit to 10,000 movies for performance
            # Validate movie ID
            try:
    ...
    def save_ratings(self, ratings_small):
        for rating in ratings_small[:100]:  # Limit to 10,000 ratings for performance
    ...
    def save_credits(self, credits_data):
        for credit in credits_data[:100]:  # Limit to 10,000 credits for performance
