ACCOUNT_CUSTOM_STATUS_CODES = {
  400: {
    ...
    "invalid_first_name": "First name is required and cannot be empty",
    "invalid_last_name": "Last name is required and cannot be empty",
    "invalid_username": "Username is required and cannot be empty",
